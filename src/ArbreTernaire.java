...
public class ArbreTernaire{
    ...
    public ArbreTernaire searchAbTer( Centre p , Image img ){
        ...
        if( this.x1 == 0 && this.y1 == 0 && this.x2 == 0 && this.y2 ==0 && this.x3 == 0 && this.y3 ==  0 ){
            if( p.getX() >= 0 && p.getX() <= img.width() && p.getY() >= 0 && p.getY() <= img.height()){
                this.droit = new ArbreTernaire(0, 0, img.height(), img.height(), 0, img.height(), Couleur.G, null, null, null, this);
                this.milieu = new ArbreTernaire(img.height(), img.height(), img.height(), 0, img.width()/2, img.height()/2,Couleur.G , null, null, null, this);
                this.gauche = new ArbreTernaire(img.height(), 0, 0, 0, img.width()/2, img.height()/2, Couleur.N, null, null, null, this);
            }
            this.x1 = 5 ; this.y1 = 54 ; this.x2 = 6 ; this.y2 = 9 ; this.x3 = 4 ; this.y3 = 12;
        }
    ...
    public void compressQTree( Recoloriage p , Image img , Data data){
        ...
        if( estVide(NoeudArecolorier)) System.out.println(" le noeud à recolorier est vide");
        else System.out.println("le noeud à recolorier n'est pas vide");
        ...
        if(    NoeudArecolorier.c == NoeudArecolorier.parent.gauche.c
            ...
            ){ System.out.println(" Noeud parent du noeud");
        ...
        else{ System.out.println("  noeud fils");
