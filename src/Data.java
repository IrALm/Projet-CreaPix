...
public class Data {
    ...
    private static MonBoTablo.Couleur choixColor( String str){

        MonBoTablo.Couleur c = null ;
        switch (str) {
            case "R":
                c = MonBoTablo.Couleur.R;
                break;
            case "B":
                c = MonBoTablo.Couleur.B;
                break;
            case "J":
                c = MonBoTablo.Couleur.J;
                break;
            case "G":
                c = MonBoTablo.Couleur.G;    
                break;
            case "N":
                c = MonBoTablo.Couleur.N;    
                break;
